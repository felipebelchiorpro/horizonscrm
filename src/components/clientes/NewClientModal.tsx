...
export function NewClientModal({ isOpen, onClose, onSuccess, initialData }: ClientModalProps) {
    ...
    return (
        <div style={{ position: 'fixed', inset: 0, zIndex: 99999, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div className="glass-panel animate-fade-in custom-scrollbar" style={{ position: 'relative', width: '100%', maxWidth: '700px', maxHeight: '90vh', overflowY: 'auto', margin: '1rem', padding: '2rem', zIndex: 100000, display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
