...
export function NewClientModal({ isOpen, onClose, onSuccess, initialData }: ClientModalProps) {
    ...
    return (
        <div style={{ position: 'fixed', inset: 0, zIndex: 99999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem 1rem' }}>
            ...
            <div className="glass-panel animate-fade-in custom-scrollbar" style={{ position: 'relative', width: '100%', maxWidth: '700px', maxHeight: '100%', overflowY: 'auto', padding: '2.5rem', zIndex: 100000, display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
